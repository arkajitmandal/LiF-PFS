...
for t in Time:
  ...
  # population in coherent representation
  cCt = DtoA(cDt, nR, nState, Uc)
  rhoC = population(cCt, nState) 
  popC.write(str(t*dt/ps) + " " + " ".join(rhoC.astype(str)) + "\n" ) 
